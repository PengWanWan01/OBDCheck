...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [self initNavBarTitle:@"Year" andLeftItemImageName:@"back" andRightItemName:@"Cancel"];
...
- (void)initWithData{
    ...
    for (NSInteger i = 0; i < 11; i++) {
        NSInteger result = 1996+i;
        [self.dataSource addObject:[NSString stringWithFormat:@"%ld",(long)result]];
    }  
}
